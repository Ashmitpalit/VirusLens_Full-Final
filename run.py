...
ADDRESS = os.getenv("VL_ADDRESS", "localhost")     # listen on localhost by default (use 0.0.0.0 for all interfaces)
PORT    = int(os.getenv("VL_PORT", "8501"))        # default port
APP     = os.getenv("VL_APP", "main.py")           # streamlit entry (main.py at root)
